"""
Django settings for dry_field_dev_61611 project.
...
ROOT_URLCONF = 'dry_field_dev_61611.urls'
...
WSGI_APPLICATION = 'dry_field_dev_61611.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dry_field_dev_61611 API",
    "DESCRIPTION": "API documentation for dry_field_dev_61611 App",
    "VERSION": "v1",
}
